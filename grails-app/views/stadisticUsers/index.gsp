...
<html>
  ...
  <g:set var="entityName" value="Estadisticas Usuarios" />
...
<div class="body">
  <g:form name="frm-qry" action="query" >
    ...
    <table style="border: none; width: 750px;"> 
      ...
      <g:select name="option" from="${[ 'Rotacion Inventario x Bodega', 'Rotacion Inventario x Proveedor', 'Rotacion Inventario x Articulo']}"
